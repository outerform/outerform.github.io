...
\leftskip=1.5em
\section{Profile}
My work centers on eXplainable Artificial Intelligence (XAI), especially high-performance and efficient explanation methods for LLMs and multimodal models, as well as explanation-guided model optimization and control. Beyond academic research, I have hands-on pre-training experience with LLMs and multimodal/image-generation models. In addition, my competitive programming background, including NOI and ICPC/CCPC gold medals, provides a strong algorithmic foundation and engineering discipline for building reliable AI systems.
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Liu, Junhao}, Haonan Yu, Zhenyu Yan, and Xin Zhang. \href{https://aclanthology.org/2026.acl-long.220/}{Revitalizing Black-Box Interpretability: Actionable Interpretability for LLMs via Proxy Models.} ACL 2026, Main Conference (Oral, 4.12\%).\vspace{0.2cm}\\
    ...
    \item \textbf{Liu, Junhao}, and Xin Zhang. \href{https://ojs.aaai.org/index.php/AAAI/article/view/34079}{ReX: A framework for incorporating temporal information in model-agnostic local explanation techniques.} AAAI 2025 (Oral, 4.68\%).\vspace{0.2cm}\\
...
\section{Preprints}
\begin{itemize}[leftmargin=*]
    \item \textbf{Liu, Junhao}, Jian-Wei Zhang, Tao Huang, Miles Yang, Zhao Zhong, and Liefeng Bo. \href{https://arxiv.org/abs/2607.16409}{Think, Plan, Paint: Layout-Aware Reasoning for Controllable Image Generation in Unified Models.} arXiv:2607.16409 (2026).\vspace{0.2cm}\\
    ...
    \item \textbf{Liu, Junhao}, Haonan Yu, and Xin Zhang. \href{https://arxiv.org/pdf/2410.12439}{Concept-Based Local Unified Explanations.} arXiv:2410.12439 (2024).\vspace{0.2cm}\\
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Work Focus}
          {Contributing to large language model pre-training, with responsibility for code-corpus processing and multi-source data mixture strategy design.}
      \resumeItemListEnd
    \resumeSubheading
