...
\newcommand{\CVPhoneFieldEN}{}
\ifdefined\CVPhone
  \renewcommand{\CVPhoneFieldEN}{& \textbf{Phone:} \CVPhone}
\fi
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \textbf{Homepage:} https://outerform.site \CVPhoneFieldEN \\
\end{tabular*}

\leftskip=1.5em
\section{Profile}
My work centers on eXplainable Artificial Intelligence (XAI), especially scalable methods for explaining, improving, and controlling LLMs and multimodal models. I combine research on post-hoc interpretability, concept-level explanations, and controllable generation with hands-on MLLM and LLM pre-training experience from Tencent Hunyuan and Xiaohongshu, including image-generation model R\&D, code data processing, and training dataset construction. My competitive programming background, including NOI and ICPC/CCPC gold medals, provides a strong algorithmic foundation and engineering discipline for building reliable AI systems.
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Liu, Junhao}, Haonan Yu, Zhenyu Yan, and Xin Zhang. \href{https://arxiv.org/abs/2505.12509}{Revitalizing Black-Box Interpretability: Actionable Interpretability for LLMs via Proxy Models.} ACL 2026, Main Conference (Oral, 4.12\%).\vspace{0.2cm}\\
    ...
    \item \textbf{Liu, Junhao}, Haonan Yu, Zhenyu Yan, and Xin Zhang. \href{https://arxiv.org/abs/2602.04607}{Focus-LIME: Surgical Interpretation of Long-Context Large Language Models via Proxy-Based Neighborhood Selection.} IJCAI-ECAI 2026.\vspace{0.2cm}\\
    ...
    \item Yu, Haonan, \textbf{Junhao Liu}, and Xin Zhang. \href{https://arxiv.org/abs/2502.11068}{MAnchors: Memorization-Based Acceleration of Anchors via Rule Reuse and Transformation.} ICML 2026.\vspace{0.2cm}\\
...
\section{Preprints}
\begin{itemize}[leftmargin=*]
    \item \textbf{Liu, Junhao}, Jian-Wei Zhang, Tao Huang, Miles Yang, Zhao Zhong, and Liefeng Bo. \href{https://outerform.site/assets/pdf/papers/atlas.pdf}{Think, Plan, Paint: Layout-Aware Reasoning for Controllable Image Generation in Unified Models.} (2026).\vspace{0.2cm}\\
        {\small \textbf{Abstract:} Unified MLLMs still struggle to follow complex spatial instructions and logical constraints in controllable image generation. We present ATLAS, a unified framework that equips MLLMs with a ``Think, Plan, and Paint'' paradigm using layout as the shared representation across spatial reasoning, explicit object planning, and image rendering. ATLAS achieves state-of-the-art performance among MLLMs on image generation benchmarks and also supports instruction-guided editing and multimodal grounding.}

    \item \textbf{Liu, Junhao}, Haonan Yu, and Xin Zhang. \href{https://arxiv.org/pdf/2410.12439}{Concept-Based Local Unified Explanations.} (2024).\vspace{0.2cm}\\
    ...
    \item Yu, Haonan, \textbf{Junhao Liu}, Zhenyu Yan, Haoran Lin, and Xin Zhang. \href{https://arxiv.org/abs/2603.18474}{WASD: Locating Critical Neurons as Sufficient Conditions for Explaining and Controlling LLM Behavior.} (2026).\vspace{0.2cm}\\
...
\section{Internship Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Work Focus}
          {Contributing to the data pipeline for large language model pre-training, with a focus on code data processing, data mixture configuration, and training dataset construction.}
      \resumeItemListEnd
    \resumeSubheading
