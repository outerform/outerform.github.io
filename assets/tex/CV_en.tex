...
\leftskip=1.5em
\section{Profile}
My work centers on eXplainable Artificial Intelligence (XAI), especially efficient methods for explaining LLMs and multimodal models, as well as explanation-guided model optimization and control. Beyond academic research, I have hands-on pre-training experience with LLMs and multimodal/image-generation models. In addition, my competitive programming background, including NOI and ICPC/CCPC gold medals, provides a strong algorithmic foundation and engineering discipline for building reliable AI systems.
