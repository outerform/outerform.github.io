...
\leftskip=1.5em
\section{个人简介}
我的研究聚焦可解释人工智能（XAI），尤其关注面向 LLM 与多模态模型的高性能与高效解释方法，以及基于解释的模型优化与控制。除学术研究外，我拥有大语言模型与多模态/图像生成模型预训练经验。此外，长期算法竞赛训练（NOI 金牌、ICPC/CCPC 金牌）也为我提供了扎实的算法基础与工程实现能力。
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Liu, Junhao}, Haonan Yu, Zhenyu Yan, and Xin Zhang. \href{https://aclanthology.org/2026.acl-long.220/}{Revitalizing Black-Box Interpretability: Actionable Interpretability for LLMs via Proxy Models.} ACL 2026 主会（Oral, 4.12\%）。\vspace{0.2cm}\\
